...
const SOCIAL_LINKS = [
  {
    name: 'GitHub',
    link: 'https://github.com/crismorgantee',
  },
  {
    name: 'Medium',
    link: 'https://medium.com/@cristianomorgante',
  },
  {
    name: 'Twitter',
    link: 'https://twitter.com/crismorgantee',
  },
        ...
        <div className="row">
          <div className="col-lg-8 col-md-12">
            <Block>
              ...
              <P>No menu ao lado você pode cadastrar novos jogos, criar categorias e muito mais!</P>
